...
public class Signup extends JFrame implements ActionListener {
	...
	Signup() {
		...
		c3.setBounds(460,240,100,30);
		add(c3);
		
		l15.setBounds(570,240,40,30);
		add(l15);
		
		c2.setBounds(610,240,90,30);
		add(c2);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			if(t6.getText().equals("")) {
				...
				// Here we use executeUpdate instead executeQuery beacuse here we are inserting the value...
				// To retrieve the value from DB we use executeQuery method...
